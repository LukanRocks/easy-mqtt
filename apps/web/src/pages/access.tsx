...
export function AccessPage() {
  ...
  return (
    <>
      <PageHeader
        title="Access"
        description="Check which roles grant access to a concrete topic (allow rules only)."
      />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter a concrete topic (no wildcards) to see which role ACLs match it.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form
          ...
          >
            <Input
              ...
              placeholder="sensors/livingroom/temperature"
              className="font-mono"
            />
          ...
          <CardContent>
            {isFetching ? (
                ...
                {data.map((role) => (
                  <div key={role.rolename} className="rounded-lg border p-4">
                    <div className="mb-2 flex items-center gap-2">
                      ...
                      {role.textname && (
                        <span className="text-sm text-muted-foreground">({role.textname})</span>
                      )}
                    </div>
              ...
              <p className="text-sm text-muted-foreground">
                No role grants access to this topic.
              </p>
            )}
          </CardContent>
        </Card>
